...
class YahooFinance(ExchangeBase):
    ...
    async def get_rates(self, ccy):
        json = await self.get_json('query1.finance.yahoo.com', '/v8/finance/chart/QTC37629-USD')
        return {'USD': to_decimal(json['chart']['result'][0]['meta']['regularMarketPrice'])}

    def history_ccys(self):
        return ['USD']

    async def request_history(self, ccy):
        # TODO: Implement history if needed, for now just current rate
        return {}
